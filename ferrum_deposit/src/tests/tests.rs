...
mod tests {
    ...
    const CLIENT_DATA_DIR: &str = "src/tests/deposit/data";
    ...
    async fn test_put_expects_success() {
        ...
        let deposit_client = FerrumDepositClient::from_config(DepositConfig {
        ...
        let result = deposit_client.put(local_file, put_file_response).await;
        ...
        let valid_result = deposit_client
    ...
    async fn test_put_expects_failure() {
        ...
        let directory_does_not_exist_result = deposit_client
            .put(local_file_valid_test, valid_put_file_response)
            .await;
        assert_eq!(
    ...
    async fn test_get_expects_success() {
        ...
        let client = FerrumDepositClient::from_config(DepositConfig {
            namenode_address: format!("{}:{}", LOCALHOST_IPV4, namenode_port),
            data_dir: CLIENT_DATA_DIR.to_string(),
        });
