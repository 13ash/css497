...
pub struct Job<InitialKey, InitialValue, IntermediateKey, InterMediateValue, FinalKey, FinalValue> {
    ...
    pub mapper_function: Arc<dyn Mapper<InitialKey, InitialValue, IntermediateKey, InterMediateValue>>,
...
impl<InitialKey, InitialValue, IntermediateKey, IntermediateValue, FinalKey, FinalValue> Job<InitialKey, InitialValue, IntermediateKey, IntermediateValue, FinalKey, FinalValue> {
    pub fn new(
        input_data: InputType,
        output_location: PathBuf,
        mapper_function: Arc<dyn Mapper<InitialKey, InitialValue, IntermediateKey, IntermediateValue>>,
